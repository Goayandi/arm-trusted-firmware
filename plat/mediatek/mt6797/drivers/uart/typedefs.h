...
extern void WRITE_REGISTER_UINT8(uintptr_t addr, uint8_t value);
extern uint8_t READ_REGISTER_UINT8(uintptr_t addr);

extern void WRITE_REGISTER_UINT16(uintptr_t addr, uint16_t value);
extern uint16_t READ_REGISTER_UINT16(uintptr_t addr);

extern void WRITE_REGISTER_UINT32(uintptr_t addr, uint32_t value);
extern uint32_t READ_REGISTER_UINT32(uintptr_t addr);

#else
#define READ_REGISTER_UINT32(reg) \
    (*(volatile UINT32 * const)(uintptr_t)(reg))

#define WRITE_REGISTER_UINT32(reg, val) \
    (*(volatile UINT32 * const)(uintptr_t)(reg)) = (val)

#define READ_REGISTER_UINT16(reg) \
    (*(volatile UINT16 * const)(uintptr_t)(reg))

#define WRITE_REGISTER_UINT16(reg, val) \
    (*(volatile UINT16 * const)(uintptr_t)(reg)) = (val)

#define READ_REGISTER_UINT8(reg) \
    (*(volatile UINT8 * const)(uintptr_t)(reg))

#define WRITE_REGISTER_UINT8(reg, val) \
    (*(volatile UINT8 * const)(uintptr_t)(reg)) = (val)
#endif
...
#define OUTREG16(x, y)              WRITE_REGISTER_UINT16((x),(UINT16)(y))
#define SETREG16(x, y)              OUTREG16(x, INREG16(x)|(y))
#define CLRREG16(x, y)              OUTREG16(x, INREG16(x)&~(y))
#define MASKREG16(x, y, z)          OUTREG16(x, (INREG16(x)&~(y))|(z))

#define INREG32(x)                  READ_REGISTER_UINT32((x))
#define OUTREG32(x, y)              WRITE_REGISTER_UINT32((x), (UINT32)(y))
