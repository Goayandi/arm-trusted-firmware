...
#define SPM_PCM_CON0			(SPM_BASE + 0x018)
#define SPM_PCM_CON1			(SPM_BASE + 0x01C)
#define SPM_PCM_IM_PTR			(SPM_BASE + 0x020)
#define SPM_PCM_IM_LEN			(SPM_BASE + 0x024)
#define SPM_PCM_REG_DATA_INI		(SPM_BASE + 0x028)
#define SPM_PCM_PWR_IO_EN		(SPM_BASE + 0x02C)
#define SPM_PCM_TIMER_VAL		(SPM_BASE + 0x030)
#define SPM_PCM_WDT_VAL			(SPM_BASE + 0x034)
#define SPM_PCM_IM_HOST_RW_PTR		(SPM_BASE + 0x038)
#define SPM_PCM_IM_HOST_RW_DAT		(SPM_BASE + 0x03C)

#define SPM_PCM_EVENT_VECTOR0		(SPM_BASE + 0x040)
#define SPM_PCM_EVENT_VECTOR1		(SPM_BASE + 0x044)
#define SPM_PCM_EVENT_VECTOR2		(SPM_BASE + 0x048)
#define SPM_PCM_EVENT_VECTOR3		(SPM_BASE + 0x04C)
#define SPM_PCM_EVENT_VECTOR4		(SPM_BASE + 0x050)
#define SPM_PCM_EVENT_VECTOR5		(SPM_BASE + 0x054)
#define SPM_PCM_EVENT_VECTOR6		(SPM_BASE + 0x058)
#define SPM_PCM_EVENT_VECTOR7		(SPM_BASE + 0x05C)
#define SPM_PCM_EVENT_VECTOR8		(SPM_BASE + 0x060)
#define SPM_PCM_EVENT_VECTOR9		(SPM_BASE + 0x064)
#define SPM_PCM_EVENT_VECTOR10		(SPM_BASE + 0x068)
#define SPM_PCM_EVENT_VECTOR11		(SPM_BASE + 0x06C)
#define SPM_PCM_EVENT_VECTOR12		(SPM_BASE + 0x070)
#define SPM_PCM_EVENT_VECTOR13		(SPM_BASE + 0x074)
#define SPM_PCM_EVENT_VECTOR14		(SPM_BASE + 0x078)
#define SPM_PCM_EVENT_VECTOR15		(SPM_BASE + 0x07C)
#define SPM_PCM_EVENT_VECTOR_EN		(SPM_BASE + 0x080)
...
#define SPM_SCP_CLK_CON			(SPM_BASE + 0x0D0)
#define SPM_PCM_DEBUG_CON		(SPM_BASE + 0x0D4)

#define SPM_PCM_REG0_DATA                  (SPM_BASE + 0x100)
#define SPM_PCM_REG1_DATA                  (SPM_BASE + 0x104)
#define SPM_PCM_REG2_DATA                  (SPM_BASE + 0x108)
#define SPM_PCM_REG3_DATA                  (SPM_BASE + 0x10C)
#define SPM_PCM_REG4_DATA                  (SPM_BASE + 0x110)
#define SPM_PCM_REG5_DATA                  (SPM_BASE + 0x114)
#define SPM_PCM_REG6_DATA                  (SPM_BASE + 0x118)
#define SPM_PCM_REG7_DATA                  (SPM_BASE + 0x11C)
#define SPM_PCM_REG8_DATA                  (SPM_BASE + 0x120)
#define SPM_PCM_REG9_DATA                  (SPM_BASE + 0x124)
#define SPM_PCM_REG10_DATA                 (SPM_BASE + 0x128)
#define SPM_PCM_REG11_DATA                 (SPM_BASE + 0x12C)
#define SPM_PCM_REG12_DATA                 (SPM_BASE + 0x130)
#define SPM_PCM_REG13_DATA                 (SPM_BASE + 0x134)
#define SPM_PCM_REG14_DATA                 (SPM_BASE + 0x138)
#define SPM_PCM_REG15_DATA                 (SPM_BASE + 0x13C)
#define SPM_PCM_REG12_MASK_B_STA           (SPM_BASE + 0x140)
#define SPM_PCM_REG12_EXT_DATA             (SPM_BASE + 0x144)
#define SPM_PCM_REG12_EXT_MASK_B_STA       (SPM_BASE + 0x148)

#define SPM_PCM_EVENT_REG_STA              (SPM_BASE + 0x14C)
#define SPM_PCM_TIMER_OUT                  (SPM_BASE + 0x150)
#define SPM_PCM_WDT_OUT                    (SPM_BASE + 0x154)
...
#define SPM_BUS_PROTECT_RDY                (SPM_BASE + 0x168)
#define SPM_BUS_PROTECT2_RDY               (SPM_BASE + 0x16C)
#define SPM_SUBSYS_IDLE_STA                (SPM_BASE + 0x170)
#define SPM_CPU_IDLE_STA                   (SPM_BASE + 0x174)
#define SPM_CPU_IDLE_STA2                  (SPM_BASE + 0x178)
#define SPM_PCM_FSM_STA                    (SPM_BASE + 0x17C)
...
#define SPM_PCM_WDT_LATCH_0                (SPM_BASE + 0x190)
#define SPM_PCM_WDT_LATCH_1                (SPM_BASE + 0x194)
#define SPM_PCM_WDT_LATCH_2                (SPM_BASE + 0x198)
#define SPM_DRAMC_DBG_LATCH                (SPM_BASE + 0x19C)
...
#define SPM_PCM_WDT_LATCH_3		(SPM_BASE + 0x1C4)
#define SPM_PCM_WDT_LATCH_4		(SPM_BASE + 0x1C8)

#define SPM_SPM_SRC_RDY_STA		(SPM_BASE + 0x1D0)

#define SPM_SPM_WAKEUP_MISC2		(SPM_BASE + 0x1E0)
#define SPM_CPU_RET_STATUS		(SPM_BASE + 0x1E4)

#define SPM_MCUSYS_PWR_CON		(SPM_BASE + 0x200)
#define SPM_MP_TOP_PWR_CON		(SPM_BASE + 0x204)
...
#define SPM_MP3_CPUSYS_PWR_CON		(SPM_BASE + 0x21C)

#define SPM_MP0_CPU0_PWR_CON		(SPM_BASE + 0x220)
#define SPM_MP0_CPU1_PWR_CON		(SPM_BASE + 0x224)
#define SPM_MP0_CPU2_PWR_CON		(SPM_BASE + 0x228)
#define SPM_MP0_CPU3_PWR_CON		(SPM_BASE + 0x22C)

#define SPM_MP1_CPU0_PWR_CON		(SPM_BASE + 0x230)
#define SPM_MP1_CPU1_PWR_CON		(SPM_BASE + 0x234)
#define SPM_MP1_CPU2_PWR_CON		(SPM_BASE + 0x238)
#define SPM_MP1_CPU3_PWR_CON		(SPM_BASE + 0x23C)

#define SPM_MP2_CPU0_PWR_CON		(SPM_BASE + 0x240)
#define SPM_MP2_CPU1_PWR_CON		(SPM_BASE + 0x244)
#define SPM_MP2_CPU2_PWR_CON		(SPM_BASE + 0x248)
#define SPM_MP2_CPU3_PWR_CON		(SPM_BASE + 0x24C)

#define SPM_MP3_CPU0_PWR_CON		(SPM_BASE + 0x250)
#define SPM_MP3_CPU1_PWR_CON		(SPM_BASE + 0x254)
...
#define SPM_VEN_PWR_CON                    (SPM_BASE + 0x304)
#define SPM_ISP_PWR_CON                    (SPM_BASE + 0x308)
#define SPM_DIS_PWR_CON                    (SPM_BASE + 0x30C)
#define SPM_MJC_PWR_CON                    (SPM_BASE + 0x310)
#define SPM_AUDIO_PWR_CON                  (SPM_BASE + 0x314)
#define SPM_IFR_PWR_CON                    (SPM_BASE + 0x318)
#define SPM_DPY_PWR_CON                    (SPM_BASE + 0x31C)
#define SPM_MD1_PWR_CON                    (SPM_BASE + 0x320)
#define SPM_MD2_PWR_CON                    (SPM_BASE + 0x324)
#define SPM_C2K_PWR_CON                    (SPM_BASE + 0x328)
#define SPM_CONN_PWR_CON                   (SPM_BASE + 0x32C)
#define SPM_VCOREPDN_PWR_CON               (SPM_BASE + 0x330)
#define SPM_MFG_ASYNC_PWR_CON              (SPM_BASE + 0x334)
#define SPM_MFG_PWR_CON                    (SPM_BASE + 0x338)
#define SPM_MFG_SRAM_CON                   (SPM_BASE + 0x33C)
#define SPM_MFG_CORE0_PWR_CON              (SPM_BASE + 0x340)
#define SPM_MFG_CORE1_PWR_CON              (SPM_BASE + 0x344)
#define SPM_MFG_CORE2_PWR_CON              (SPM_BASE + 0x348)
#define SPM_MFG_CORE3_PWR_CON              (SPM_BASE + 0x34C)
#define SPM_SYSRAM_CON                     (SPM_BASE + 0x350)
#define SPM_SYSROM_CON                     (SPM_BASE + 0x354)
#define SPM_SCP_SRAM_CON                   (SPM_BASE + 0x358)
#define SPM_GCPU_SRAM_CON                  (SPM_BASE + 0x35C)
#define SPM_MDSYS_INTF_INFRA_PWR_CON       (SPM_BASE + 0x360)
#define SPM_MDSYS_INTF_MD1_PWR_CON         (SPM_BASE + 0x364)
#define SPM_MDSYS_INTF_C2K_PWR_CON         (SPM_BASE + 0x368)
#define SPM_BSI_TOP_SRAM_CON               (SPM_BASE + 0x370)
#define SPM_DVFSP0_SRAM_CON                (SPM_BASE + 0x374)
#define SPM_DVFSP1_SRAM_CON                (SPM_BASE + 0x378)
#define SPM_MD_EXT_BUCK_ISO                (SPM_BASE + 0x390)
#define SPM_DUMMY2_PWR_CON                 (SPM_BASE + 0x3B0)
#define SPM_DUMMY3_PWR_CON                 (SPM_BASE + 0x3B4)
#define SPM_DPY_CH1_PWR_CON                (SPM_BASE + 0x3B8)
...
#define SPM_AP2MD_CROSS_TRIGGER            (SPM_BASE + 0x430)
#define SPM_AP_MDSRC_REQ                   (SPM_BASE + 0x434)
#define SPM_SPM2MD_DVFS_CON                (SPM_BASE + 0x438)
#define SPM_MD2SPM_DVFS_CON                (SPM_BASE + 0x43C)
#define SPM_DRAMC_DPY_CLK_SW_CON           (SPM_BASE + 0x440)
#define SPM_DPY_LP_CON                     (SPM_BASE + 0x444)
#define SPM_CPU_DVFS_REQ                   (SPM_BASE + 0x448)
#define SPM_PLL_CON                    (SPM_BASE + 0x44C)
#define SPM_EMI_BW_MODE                (SPM_BASE + 0x450)
#define SPM_AP2MD_PEER_WAKEUP              (SPM_BASE + 0x454)
#define SPM_ULPOSC_CON                     (SPM_BASE + 0x458)

#define SPM_MP0_CPU0_IRQ_MASK              (SPM_BASE + 0x500)
#define SPM_MP0_CPU1_IRQ_MASK              (SPM_BASE + 0x504)
#define SPM_MP0_CPU2_IRQ_MASK              (SPM_BASE + 0x508)
#define SPM_MP0_CPU3_IRQ_MASK              (SPM_BASE + 0x50C)
#define SPM_MP1_CPU0_IRQ_MASK              (SPM_BASE + 0x510)
#define SPM_MP1_CPU1_IRQ_MASK              (SPM_BASE + 0x514)
#define SPM_MP1_CPU2_IRQ_MASK              (SPM_BASE + 0x518)
#define SPM_MP1_CPU3_IRQ_MASK              (SPM_BASE + 0x51C)
#define SPM_MP2_CPU0_IRQ_MASK              (SPM_BASE + 0x520)
#define SPM_MP2_CPU1_IRQ_MASK              (SPM_BASE + 0x524)
#define SPM_MP2_CPU2_IRQ_MASK              (SPM_BASE + 0x528)
#define SPM_MP2_CPU3_IRQ_MASK              (SPM_BASE + 0x52C)
#define SPM_MP3_CPU0_IRQ_MASK              (SPM_BASE + 0x530)
#define SPM_MP3_CPU1_IRQ_MASK              (SPM_BASE + 0x534)
#define SPM_MP3_CPU2_IRQ_MASK              (SPM_BASE + 0x538)
#define SPM_MP3_CPU3_IRQ_MASK              (SPM_BASE + 0x53C)
#define SPM_MP0_CPU0_WFI_EN                (SPM_BASE + 0x540)
#define SPM_MP0_CPU1_WFI_EN                (SPM_BASE + 0x544)
#define SPM_MP0_CPU2_WFI_EN                (SPM_BASE + 0x548)
#define SPM_MP0_CPU3_WFI_EN                (SPM_BASE + 0x54C)
#define SPM_MP1_CPU0_WFI_EN                (SPM_BASE + 0x550)
#define SPM_MP1_CPU1_WFI_EN                (SPM_BASE + 0x554)
#define SPM_MP1_CPU2_WFI_EN                (SPM_BASE + 0x558)
#define SPM_MP1_CPU3_WFI_EN                (SPM_BASE + 0x55C)
#define SPM_MP2_CPU0_WFI_EN                (SPM_BASE + 0x560)
#define SPM_MP2_CPU1_WFI_EN                (SPM_BASE + 0x564)
#define SPM_MP2_CPU2_WFI_EN                (SPM_BASE + 0x568)
#define SPM_MP2_CPU3_WFI_EN                (SPM_BASE + 0x56C)
#define SPM_MP3_CPU0_WFI_EN                (SPM_BASE + 0x570)
#define SPM_MP3_CPU1_WFI_EN                (SPM_BASE + 0x574)
#define SPM_MP3_CPU2_WFI_EN                (SPM_BASE + 0x578)
#define SPM_MP3_CPU3_WFI_EN                (SPM_BASE + 0x57C)
...
#define MP2_CPUTOP_IDLE_MASK_LSB            (1U << 3)       /* 1b */
#define MP3_CPUTOP_IDLE_MASK_LSB            (1U << 4)       /* 1b */
#define MP_TOP_IDLE_MASK_LSB                (1U << 5)       /* 1b */
#define MCUSYS_IDLE_MASK_LSB                (1U << 6)       /* 1b */
...
#define SPM_SW_INT_SET_LSB                  (1U << 0)       /* 18b */

/* SPM_SW_INT_CLEAR (0x10006000+0x094) */
#define SPM_SW_INT_CLEAR_LSB                (1U << 0)       /* 18b */
...
#define SPM_IRQ_MASK_LSB                    (1U << 8)       /* 18b */
...
#define DISP_OD_REQ_MASK_B_LSB              (1U << 27)      /* 1b */
...
#define MP1_CPU3_STANDBYWFI_LSB             (1U << 17)      /* 1b */ #define MP0_CPUTOP_IDLE_LSB                 (1U << 20)      /* 1b */
#define MP1_CPUTOP_IDLE_LSB                 (1U << 21)      /* 1b */
#define MCUSYS_IDLE_LSB                     (1U << 23)      /* 1b */
/* CPU_IDLE_STA2 (0x10006000+0x178) */
#define MP2_CPU0_STANDBYWFI_AFTER_SEL_LSB   (1U << 0)       /* 1b */
#define MP2_CPU1_STANDBYWFI_AFTER_SEL_LSB   (1U << 1)       /* 1b */
#define MP2_CPU2_STANDBYWFI_AFTER_SEL_LSB   (1U << 2)       /* 1b */
#define MP2_CPU3_STANDBYWFI_AFTER_SEL_LSB   (1U << 3)       /* 1b */
#define MP3_CPU0_STANDBYWFI_AFTER_SEL_LSB   (1U << 4)       /* 1b */
#define MP3_CPU1_STANDBYWFI_AFTER_SEL_LSB   (1U << 5)       /* 1b */
#define MP3_CPU2_STANDBYWFI_AFTER_SEL_LSB   (1U << 6)       /* 1b */
#define MP3_CPU3_STANDBYWFI_AFTER_SEL_LSB   (1U << 7)       /* 1b */
#define MP2_CPU0_STANDBYWFI_LSB             (1U << 10)      /* 1b */
#define MP2_CPU1_STANDBYWFI_LSB             (1U << 11)      /* 1b */
#define MP2_CPU2_STANDBYWFI_LSB             (1U << 12)      /* 1b */
#define MP2_CPU3_STANDBYWFI_LSB             (1U << 13)      /* 1b */
#define MP3_CPU0_STANDBYWFI_LSB             (1U << 14)      /* 1b */
#define MP3_CPU1_STANDBYWFI_LSB             (1U << 15)      /* 1b */
#define MP3_CPU2_STANDBYWFI_LSB             (1U << 16)      /* 1b */
#define MP3_CPU3_STANDBYWFI_LSB             (1U << 17)      /* 1b */
#define MP2_CPUTOP_IDLE_LSB                 (1U << 20)      /* 1b */
#define MP3_CPUTOP_IDLE_LSB                 (1U << 21)      /* 1b */
#define MP_TOP_IDLE_LSB                     (1U << 23)      /* 1b */
/* PCM_FSM_STA (0x10006000+0x17C) */
...
/* PCM_WDT_LATCH_4 (0x10006000+0x1C8) */
...
/* SPM_WAKEUP_MISC2 (0x10006000+0x1E0) */
#define SPM_WAKEUP_EVENT_MISC2_LSB          (1U << 0)       /* 32b */
/* CPU_RET_STATUS (0x10006000+0x1E4) */
...
#define MCU_SRAM_PDN_ACK_LSB                (1U << 12)      /* 1b */
/* MP_TOP_PWR_CON (0x10006000+0x204) */
...
#define MP_TOP_PD_SLPB_CLAMP_LSB            (1U << 9)       /* 1b */
#define MP_TOP_SRAM_PDN_ACK_LSB             (1U << 12)      /* 1b */
/* MP0_CPUSYS_PWR_CON (0x10006000+0x210) */
...
#define MP0_CPUTOP_SRAM_PDN_ACK_LSB         (1U << 12)      /* 1b */
#define MP0_CPUTOP_SRAM_SLEEP_B_LSB         (1U << 16)      /* 1b */
#define MP0_CPUTOP_SRAM_SLEEP_B_ACK_LSB     (1U << 19)      /* 1b */
/* MP1_CPUSYS_PWR_CON (0x10006000+0x214) */
...
#define MP1_CPUTOP_SRAM_PDN_ACK_LSB         (1U << 12)      /* 1b */
#define MP1_CPUTOP_SRAM_SLEEP_B_LSB         (1U << 16)      /* 1b */
#define MP1_CPUTOP_SRAM_SLEEP_B_ACK_LSB     (1U << 19)      /* 1b */
/* MP2_CPUSYS_PWR_CON (0x10006000+0x218) */
#define MP2_CPUTOP_PWR_RST_B_LSB            (1U << 0)       /* 1b */
#define MP2_CPUTOP_PWR_ISO_LSB              (1U << 1)       /* 1b */
#define MP2_CPUTOP_PWR_ON_LSB               (1U << 2)       /* 1b */
#define MP2_CPUTOP_PWR_ON_2ND_LSB           (1U << 3)       /* 1b */
#define MP2_CPUTOP_PWR_CLK_DIS_LSB          (1U << 4)       /* 1b */
#define MP2_CPUTOP_SRAM_CKISO_LSB           (1U << 5)       /* 1b */
#define MP2_CPUTOP_SRAM_ISOINT_B_LSB        (1U << 6)       /* 1b */
#define MP2_CPUTOP_SRAM_PDN_LSB             (1U << 8)       /* 1b */
#define MP2_CPUTOP_SRAM_PDN_ACK_LSB         (1U << 12)      /* 1b */
#define MP2_CPUTOP_SRAM_SLEEP_B_LSB         (1U << 16)      /* 1b */
#define MP2_CPUTOP_SRAM_SLEEP_B_ACK_LSB     (1U << 19)      /* 1b */
/* MP3_CPUSYS_PWR_CON (0x10006000+0x21C) */
#define MP3_CPUTOP_PWR_RST_B_LSB            (1U << 0)       /* 1b */
#define MP3_CPUTOP_PWR_ISO_LSB              (1U << 1)       /* 1b */
#define MP3_CPUTOP_PWR_ON_LSB               (1U << 2)       /* 1b */
#define MP3_CPUTOP_PWR_ON_2ND_LSB           (1U << 3)       /* 1b */
#define MP3_CPUTOP_PWR_CLK_DIS_LSB          (1U << 4)       /* 1b */
#define MP3_CPUTOP_SRAM_CKISO_LSB           (1U << 5)       /* 1b */
#define MP3_CPUTOP_SRAM_ISOINT_B_LSB        (1U << 6)       /* 1b */
#define MP3_CPUTOP_SRAM_PDN_LSB             (1U << 8)       /* 1b */
#define MP3_CPUTOP_SRAM_PDN_ACK_LSB         (1U << 12)      /* 1b */
#define MP3_CPUTOP_SRAM_SLEEP_B_LSB         (1U << 16)      /* 1b */
#define MP3_CPUTOP_SRAM_SLEEP_B_ACK_LSB     (1U << 19)      /* 1b */
/* MP0_CPU0_PWR_CON (0x10006000+0x220) */
...
#define MP0_CPU0_PD_SLPB_CLAMP_LSB          (1U << 9)       /* 1b */
#define MP0_CPU0_SRAM_PDN_ACK_LSB           (1U << 12)      /* 1b */
#define MP0_CPU0_SRAM_SLEEP_B_LSB           (1U << 16)      /* 1b */
/* MP0_CPU1_PWR_CON (0x10006000+0x224) */
...
#define MP0_CPU1_PD_SLPB_CLAMP_LSB          (1U << 9)       /* 1b */
#define MP0_CPU1_SRAM_PDN_ACK_LSB           (1U << 12)      /* 1b */
#define MP0_CPU1_SRAM_SLEEP_B_LSB           (1U << 16)      /* 1b */
/* MP0_CPU2_PWR_CON (0x10006000+0x228) */
...
#define MP0_CPU2_PD_SLPB_CLAMP_LSB          (1U << 9)       /* 1b */
#define MP0_CPU2_SRAM_PDN_ACK_LSB           (1U << 12)      /* 1b */
#define MP0_CPU2_SRAM_SLEEP_B_LSB           (1U << 16)      /* 1b */
/* MP0_CPU3_PWR_CON (0x10006000+0x22C) */
...
#define MP0_CPU3_PD_SLPB_CLAMP_LSB          (1U << 9)       /* 1b */
#define MP0_CPU3_SRAM_PDN_ACK_LSB           (1U << 12)      /* 1b */
#define MP0_CPU3_SRAM_SLEEP_B_LSB           (1U << 16)      /* 1b */
/* MP1_CPU0_PWR_CON (0x10006000+0x230) */
...
#define MP1_CPU0_PD_SLPB_CLAMP_LSB          (1U << 9)       /* 1b */
#define MP1_CPU0_SRAM_PDN_ACK_LSB           (1U << 12)      /* 1b */
#define MP1_CPU0_SRAM_SLEEP_B_LSB           (1U << 16)      /* 1b */
/* MP1_CPU1_PWR_CON (0x10006000+0x234) */
...
#define MP1_CPU1_PD_SLPB_CLAMP_LSB          (1U << 9)       /* 1b */
#define MP1_CPU1_SRAM_PDN_ACK_LSB           (1U << 12)      /* 1b */
#define MP1_CPU1_SRAM_SLEEP_B_LSB           (1U << 16)      /* 1b */
/* MP1_CPU2_PWR_CON (0x10006000+0x238) */
...
#define MP1_CPU2_PD_SLPB_CLAMP_LSB          (1U << 9)       /* 1b */
#define MP1_CPU2_SRAM_PDN_ACK_LSB           (1U << 12)      /* 1b */
#define MP1_CPU2_SRAM_SLEEP_B_LSB           (1U << 16)      /* 1b */
/* MP1_CPU3_PWR_CON (0x10006000+0x23C) */
...
#define MP1_CPU3_PD_SLPB_CLAMP_LSB          (1U << 9)       /* 1b */
#define MP1_CPU3_SRAM_PDN_ACK_LSB           (1U << 12)      /* 1b */
#define MP1_CPU3_SRAM_SLEEP_B_LSB           (1U << 16)      /* 1b */
/* MP2_CPU0_PWR_CON (0x10006000+0x240) */
#define MP2_CPU0_PWR_RST_B_LSB              (1U << 0)       /* 1b */
#define MP2_CPU0_PWR_ISO_LSB                (1U << 1)       /* 1b */
#define MP2_CPU0_PWR_ON_LSB                 (1U << 2)       /* 1b */
#define MP2_CPU0_PWR_ON_2ND_LSB             (1U << 3)       /* 1b */
#define MP2_CPU0_PWR_CLK_DIS_LSB            (1U << 4)       /* 1b */
#define MP2_CPU0_SRAM_CKISO_LSB             (1U << 5)       /* 1b */
#define MP2_CPU0_SRAM_ISOINT_B_LSB          (1U << 6)       /* 1b */
#define MP2_CPU0_SRAM_PDN_LSB               (1U << 8)       /* 1b */
#define MP2_CPU0_PD_SLPB_CLAMP_LSB          (1U << 9)       /* 1b */
#define MP2_CPU0_SRAM_PDN_ACK_LSB           (1U << 12)      /* 1b */
#define MP2_CPU0_SRAM_SLEEP_B_LSB           (1U << 16)      /* 1b */
/* MP2_CPU1_PWR_CON (0x10006000+0x244) */
#define MP2_CPU1_PWR_RST_B_LSB              (1U << 0)       /* 1b */
#define MP2_CPU1_PWR_ISO_LSB                (1U << 1)       /* 1b */
#define MP2_CPU1_PWR_ON_LSB                 (1U << 2)       /* 1b */
#define MP2_CPU1_PWR_ON_2ND_LSB             (1U << 3)       /* 1b */
#define MP2_CPU1_PWR_CLK_DIS_LSB            (1U << 4)       /* 1b */
#define MP2_CPU1_SRAM_CKISO_LSB             (1U << 5)       /* 1b */
#define MP2_CPU1_SRAM_ISOINT_B_LSB          (1U << 6)       /* 1b */
#define MP2_CPU1_SRAM_PDN_LSB               (1U << 8)       /* 1b */
#define MP2_CPU1_PD_SLPB_CLAMP_LSB          (1U << 9)       /* 1b */
#define MP2_CPU1_SRAM_PDN_ACK_LSB           (1U << 12)      /* 1b */
#define MP2_CPU1_SRAM_SLEEP_B_LSB           (1U << 16)      /* 1b */
/* MP2_CPU2_PWR_CON (0x10006000+0x248) */
#define MP2_CPU2_PWR_RST_B_LSB              (1U << 0)       /* 1b */
#define MP2_CPU2_PWR_ISO_LSB                (1U << 1)       /* 1b */
#define MP2_CPU2_PWR_ON_LSB                 (1U << 2)       /* 1b */
#define MP2_CPU2_PWR_ON_2ND_LSB             (1U << 3)       /* 1b */
#define MP2_CPU2_PWR_CLK_DIS_LSB            (1U << 4)       /* 1b */
#define MP2_CPU2_SRAM_CKISO_LSB             (1U << 5)       /* 1b */
#define MP2_CPU2_SRAM_ISOINT_B_LSB          (1U << 6)       /* 1b */
#define MP2_CPU2_SRAM_PDN_LSB               (1U << 8)       /* 1b */
#define MP2_CPU2_PD_SLPB_CLAMP_LSB          (1U << 9)       /* 1b */
#define MP2_CPU2_SRAM_PDN_ACK_LSB           (1U << 12)      /* 1b */
#define MP2_CPU2_SRAM_SLEEP_B_LSB           (1U << 16)      /* 1b */
/* MP2_CPU3_PWR_CON (0x10006000+0x24C) */
#define MP2_CPU3_PWR_RST_B_LSB              (1U << 0)       /* 1b */
#define MP2_CPU3_PWR_ISO_LSB                (1U << 1)       /* 1b */
#define MP2_CPU3_PWR_ON_LSB                 (1U << 2)       /* 1b */
#define MP2_CPU3_PWR_ON_2ND_LSB             (1U << 3)       /* 1b */
#define MP2_CPU3_PWR_CLK_DIS_LSB            (1U << 4)       /* 1b */
#define MP2_CPU3_SRAM_CKISO_LSB             (1U << 5)       /* 1b */
#define MP2_CPU3_SRAM_ISOINT_B_LSB          (1U << 6)       /* 1b */
#define MP2_CPU3_SRAM_PDN_LSB               (1U << 8)       /* 1b */
#define MP2_CPU3_PD_SLPB_CLAMP_LSB          (1U << 9)       /* 1b */
#define MP2_CPU3_SRAM_PDN_ACK_LSB           (1U << 12)      /* 1b */
#define MP2_CPU3_SRAM_SLEEP_B_LSB           (1U << 16)      /* 1b */
/* MP3_CPU0_PWR_CON (0x10006000+0x250) */
#define MP3_CPU0_PWR_RST_B_LSB              (1U << 0)       /* 1b */
#define MP3_CPU0_PWR_ISO_LSB                (1U << 1)       /* 1b */
#define MP3_CPU0_PWR_ON_LSB                 (1U << 2)       /* 1b */
#define MP3_CPU0_PWR_ON_2ND_LSB             (1U << 3)       /* 1b */
#define MP3_CPU0_PWR_CLK_DIS_LSB            (1U << 4)       /* 1b */
#define MP3_CPU0_SRAM_CKISO_LSB             (1U << 5)       /* 1b */
#define MP3_CPU0_SRAM_ISOINT_B_LSB          (1U << 6)       /* 1b */
#define MP3_CPU0_SRAM_PDN_LSB               (1U << 8)       /* 1b */
#define MP3_CPU0_PD_SLPB_CLAMP_LSB          (1U << 9)       /* 1b */
#define MP3_CPU0_SRAM_PDN_ACK_LSB           (1U << 12)      /* 1b */
#define MP3_CPU0_SRAM_SLEEP_B_LSB           (1U << 16)      /* 1b */
/* MP3_CPU1_PWR_CON (0x10006000+0x254) */
#define MP3_CPU1_PWR_RST_B_LSB              (1U << 0)       /* 1b */
#define MP3_CPU1_PWR_ISO_LSB                (1U << 1)       /* 1b */
#define MP3_CPU1_PWR_ON_LSB                 (1U << 2)       /* 1b */
#define MP3_CPU1_PWR_ON_2ND_LSB             (1U << 3)       /* 1b */
#define MP3_CPU1_PWR_CLK_DIS_LSB            (1U << 4)       /* 1b */
#define MP3_CPU1_SRAM_CKISO_LSB             (1U << 5)       /* 1b */
#define MP3_CPU1_SRAM_ISOINT_B_LSB          (1U << 6)       /* 1b */
#define MP3_CPU1_SRAM_PDN_LSB               (1U << 8)       /* 1b */
#define MP3_CPU1_PD_SLPB_CLAMP_LSB          (1U << 9)       /* 1b */
#define MP3_CPU1_SRAM_PDN_ACK_LSB           (1U << 12)      /* 1b */
#define MP3_CPU1_SRAM_SLEEP_B_LSB           (1U << 16)      /* 1b */
/* MP3_CPU2_PWR_CON (0x10006000+0x258) */
#define MP3_CPU2_PWR_RST_B_LSB              (1U << 0)       /* 1b */
#define MP3_CPU2_PWR_ISO_LSB                (1U << 1)       /* 1b */
#define MP3_CPU2_PWR_ON_LSB                 (1U << 2)       /* 1b */
#define MP3_CPU2_PWR_ON_2ND_LSB             (1U << 3)       /* 1b */
#define MP3_CPU2_PWR_CLK_DIS_LSB            (1U << 4)       /* 1b */
#define MP3_CPU2_SRAM_CKISO_LSB             (1U << 5)       /* 1b */
#define MP3_CPU2_SRAM_ISOINT_B_LSB          (1U << 6)       /* 1b */
#define MP3_CPU2_SRAM_PDN_LSB               (1U << 8)       /* 1b */
#define MP3_CPU2_PD_SLPB_CLAMP_LSB          (1U << 9)       /* 1b */
#define MP3_CPU2_SRAM_PDN_ACK_LSB           (1U << 12)      /* 1b */
#define MP3_CPU2_SRAM_SLEEP_B_LSB           (1U << 16)      /* 1b */
/* MP3_CPU3_PWR_CON (0x10006000+0x25C) */
#define MP3_CPU3_PWR_RST_B_LSB              (1U << 0)       /* 1b */
#define MP3_CPU3_PWR_ISO_LSB                (1U << 1)       /* 1b */
#define MP3_CPU3_PWR_ON_LSB                 (1U << 2)       /* 1b */
#define MP3_CPU3_PWR_ON_2ND_LSB             (1U << 3)       /* 1b */
#define MP3_CPU3_PWR_CLK_DIS_LSB            (1U << 4)       /* 1b */
#define MP3_CPU3_SRAM_CKISO_LSB             (1U << 5)       /* 1b */
#define MP3_CPU3_SRAM_ISOINT_B_LSB          (1U << 6)       /* 1b */
#define MP3_CPU3_SRAM_PDN_LSB               (1U << 8)       /* 1b */
#define MP3_CPU3_PD_SLPB_CLAMP_LSB          (1U << 9)       /* 1b */
#define MP3_CPU3_SRAM_PDN_ACK_LSB           (1U << 12)      /* 1b */
#define MP3_CPU3_SRAM_SLEEP_B_LSB           (1U << 16)      /* 1b */
/* CPU_EXT_BUCK_ISO (0x10006000+0x290) */
#define L_EXT_BUCK_ISO_LSB                  (1U << 0)       /* 1b */
#define B_EXT_BUCK_ISO_LSB                  (1U << 1)       /* 1b */
/* DUMMY0_PWR_CON (0x10006000+0x2B0) */
...
/* DUMMY1_PWR_CON (0x10006000+0x2B4) */
...
/* BIG_CLK_CON (0x10006000+0x2C0) */
#define B_MUXSEL_SC_ARM_CLK_OFF_LSB         (1U << 0)       /* 1b */
#define B_MUXSEL_SC_ARMPLL_OFF_LSB          (1U << 1)       /* 1b */
#define B_MUXSEL_SC_ARMPLLOUT_OFF_LSB       (1U << 2)       /* 1b */
#define B_MUXSEL_SC_FHC_PAUSE_LSB           (1U << 3)       /* 1b */
#define B_MUXSEL_SC_ARMPLL_S_OFF_LSB        (1U << 4)       /* 1b */
#define B_SC_ARM_CLK_OFF_LSB                (1U << 8)       /* 1b */
#define B_SC_ARMPLL_OFF_LSB                 (1U << 12)      /* 1b */
#define B_SC_ARMPLLOUT_OFF_LSB              (1U << 16)      /* 1b */
#define B_SC_FHC_PAUSE_LSB                  (1U << 20)      /* 1b */
#define B_SC_ARMPLL_S_OFF_LSB               (1U << 24)      /* 1b */
/* LITTLE_CLK_CON (0x10006000+0x2C4) */
#define L_MUXSEL_SC_ARM_CLK_OFF_LSB         (1U << 0)       /* 1b */
#define L_MUXSEL_SC_ARMPLL_OFF_LSB          (1U << 1)       /* 1b */
#define L_MUXSEL_SC_ARMPLLOUT_OFF_LSB       (1U << 2)       /* 1b */
#define L_MUXSEL_SC_FHC_PAUSE_LSB           (1U << 3)       /* 1b */
#define L_MUXSEL_SC_ARMPLL_S_OFF_LSB        (1U << 4)       /* 1b */
#define L_SC_ARM_CLK_OFF_LSB                (1U << 8)       /* 4b */
#define L_SC_ARMPLL_OFF_LSB                 (1U << 12)      /* 4b */
#define L_SC_ARMPLLOUT_OFF_LSB              (1U << 16)      /* 4b */
#define L_SC_FHC_PAUSE_LSB                  (1U << 20)      /* 4b */
#define L_SC_ARMPLL_S_OFF_LSB               (1U << 24)      /* 4b */
...
#define AUD_MD32_SRAM_ISOINT_B_LSB          (1U << 16)      /* 2b */
#define AUD_MD32_SRAM_SLEEP_B_LSB           (1U << 20)      /* 2b */
#define AUD_MD32_SRAM_PDN_LSB               (1U << 24)      /* 2b */
#define AUD_MD32_SRAM_PDN_ACK_LSB           (1U << 28)      /* 2b */
...
#define IFR_SRAM_ISOINT_B_LSB               (1U << 16)      /* 4b */
#define IFR_SRAM_SLEEP_B_LSB                (1U << 20)      /* 4b */
#define IFR_SRAM_CKISO_LSB                  (1U << 24)      /* 4b */
...
/* MFG_SRAM_CON (0x10006000+0x33C) */
#define MFG_SRAM_PDN_LSB                    (1U << 0)       /* 4b */
#define MFG_SRAM_CKISO_LSB                  (1U << 4)       /* 4b */
#define MFG_SRAM_SLEEP_B_LSB                (1U << 8)       /* 4b */
#define MFG_SRAM_ISOINT_B_LSB               (1U << 12)      /* 4b */
#define MFG_SRAM_PDN_ACK_LSB                (1U << 16)      /* 4b */
#define MFG_CORE3_0_SRAM_PDN_ACK_LSB        (1U << 20)      /* 4b */
/* MFG_CORE0_PWR_CON (0x10006000+0x340) */
...
#define MFG_CORE0_SRAM_PDN_LSB              (1U << 8)       /* 1b */
/* MFG_CORE1_PWR_CON (0x10006000+0x344) */
...
#define MFG_CORE1_SRAM_PDN_LSB              (1U << 8)       /* 1b */
/* MFG_CORE2_PWR_CON (0x10006000+0x348) */
...
#define MFG_CORE2_SRAM_PDN_LSB              (1U << 8)       /* 1b */
/* MFG_CORE3_PWR_CON (0x10006000+0x34C) */
...
#define MFG_CORE3_SRAM_PDN_LSB              (1U << 8)       /* 1b */
/* SYSRAM_CON (0x10006000+0x350) */
#define IFR_SRAMROM_SRAM_PDN_LSB            (1U << 0)       /* 6b */
#define IFR_SRAMROM_SRAM_CKISO_LSB          (1U << 6)       /* 6b */
#define IFR_SRAMROM_SRAM_SLEEP_B_LSB        (1U << 12)      /* 6b */
#define IFR_SRAMROM_SRAM_ISOINT_B_LSB       (1U << 18)      /* 6b */
...
/* DVFSP0_SRAM_CON (0x10006000+0x374) */
#define DVFSP0_SRAM_PDN_LSB                 (1U << 0)       /* 2b */
#define DVFSP0_SRAM_SLEEP_B_LSB             (1U << 4)       /* 2b */
#define DVFSP0_SRAM_ISOINT_B_LSB            (1U << 8)       /* 2b */
/* DVFSP1_SRAM_CON (0x10006000+0x378) */
#define DVFSP1_SRAM_PDN_LSB                 (1U << 0)       /* 2b */
#define DVFSP1_SRAM_SLEEP_B_LSB             (1U << 4)       /* 2b */
#define DVFSP1_SRAM_ISOINT_B_LSB            (1U << 8)       /* 2b */
...
/* DUMMY3_PWR_CON (0x10006000+0x3B4) */
...
#define DUMMY3_SRAM_PDN_ACK_LSB             (1U << 12)      /* 4b */
/* DPY_CH1_PWR_CON (0x10006000+0x3B8) */
#define DPY_CH1_PWR_RST_B_LSB               (1U << 0)       /* 1b */
#define DPY_CH1_PWR_ISO_LSB                 (1U << 1)       /* 1b */
#define DPY_CH1_PWR_ON_LSB                  (1U << 2)       /* 1b */
#define DPY_CH1_PWR_ON_2ND_LSB              (1U << 3)       /* 1b */
#define DPY_CH1_PWR_CLK_DIS_LSB             (1U << 4)       /* 1b */
...
#define SW_DPY_MODE_SW_SEL_LSB              (1U << 0)       /* 2b */
#define SW_DPY_MODE_SW_LSB                  (1U << 2)       /* 2b */
#define SW_DPY_DLL_CK_EN_SEL_LSB            (1U << 4)       /* 2b */
#define SW_DPY_DLL_CK_EN_LSB                (1U << 6)       /* 2b */
#define SW_DPY_VREF_EN_SEL_LSB              (1U << 8)       /* 2b */
#define SW_DPY_VREF_EN_LSB                  (1U << 10)      /* 2b */
#define SW_EMI_CLK_OFF_SEL_LSB              (1U << 12)      /* 2b */
#define SW_EMI_CLK_OFF_LSB                  (1U << 14)      /* 2b */
#define SW_DMDRAMCSHU_SEL_LSB               (1U << 16)      /* 1b */
#define SW_DMDRAMCSHU_LSB                   (1U << 17)      /* 1b */
...
#define SC_PHYPLL_CH0_EN_LSB                (1U << 12)      /* 1b */
...
/* MP2_CPU0_IRQ_MASK (0x10006000+0x520) */
#define MP2_CPU0_IRQ_MASK_LSB               (1U << 0)       /* 1b */
#define MP2_CPU0_AUX_LSB                    (1U << 8)       /* 11b */
/* MP2_CPU1_IRQ_MASK (0x10006000+0x524) */
#define MP2_CPU1_IRQ_MASK_LSB               (1U << 0)       /* 1b */
#define MP2_CPU1_AUX_LSB                    (1U << 8)       /* 11b */
/* MP2_CPU2_IRQ_MASK (0x10006000+0x528) */
#define MP2_CPU2_IRQ_MASK_LSB               (1U << 0)       /* 1b */
#define MP2_CPU2_AUX_LSB                    (1U << 8)       /* 11b */
/* MP2_CPU3_IRQ_MASK (0x10006000+0x52C) */
#define MP2_CPU3_IRQ_MASK_LSB               (1U << 0)       /* 1b */
#define MP2_CPU3_AUX_LSB                    (1U << 8)       /* 11b */
/* MP3_CPU0_IRQ_MASK (0x10006000+0x530) */
#define MP3_CPU0_IRQ_MASK_LSB               (1U << 0)       /* 1b */
#define MP3_CPU0_AUX_LSB                    (1U << 8)       /* 11b */
/* MP3_CPU1_IRQ_MASK (0x10006000+0x534) */
#define MP3_CPU1_IRQ_MASK_LSB               (1U << 0)       /* 1b */
#define MP3_CPU1_AUX_LSB                    (1U << 8)       /* 11b */
/* MP3_CPU2_IRQ_MASK (0x10006000+0x538) */
#define MP3_CPU2_IRQ_MASK_LSB               (1U << 0)       /* 1b */
#define MP3_CPU2_AUX_LSB                    (1U << 8)       /* 11b */
/* MP3_CPU3_IRQ_MASK (0x10006000+0x53C) */
#define MP3_CPU3_IRQ_MASK_LSB               (1U << 0)       /* 1b */
#define MP3_CPU3_AUX_LSB                    (1U << 8)       /* 11b */
/* MP0_CPU0_WFI_EN (0x10006000+0x540) */
#define MP0_CPU0_WFI_EN_LSB                 (1U << 0)       /* 1b */
/* MP0_CPU1_WFI_EN (0x10006000+0x544) */
#define MP0_CPU1_WFI_EN_LSB                 (1U << 0)       /* 1b */
/* MP0_CPU2_WFI_EN (0x10006000+0x548) */
#define MP0_CPU2_WFI_EN_LSB                 (1U << 0)       /* 1b */
/* MP0_CPU3_WFI_EN (0x10006000+0x54C) */
#define MP0_CPU3_WFI_EN_LSB                 (1U << 0)       /* 1b */
/* MP1_CPU0_WFI_EN (0x10006000+0x550) */
#define MP1_CPU0_WFI_EN_LSB                 (1U << 0)       /* 1b */
/* MP1_CPU1_WFI_EN (0x10006000+0x554) */
#define MP1_CPU1_WFI_EN_LSB                 (1U << 0)       /* 1b */
/* MP1_CPU2_WFI_EN (0x10006000+0x558) */
#define MP1_CPU2_WFI_EN_LSB                 (1U << 0)       /* 1b */
/* MP1_CPU3_WFI_EN (0x10006000+0x55C) */
#define MP1_CPU3_WFI_EN_LSB                 (1U << 0)       /* 1b */
/* MP2_CPU0_WFI_EN (0x10006000+0x560) */
#define MP2_CPU0_WFI_EN_LSB                 (1U << 0)       /* 1b */
/* MP2_CPU1_WFI_EN (0x10006000+0x564) */
#define MP2_CPU1_WFI_EN_LSB                 (1U << 0)       /* 1b */
/* MP2_CPU2_WFI_EN (0x10006000+0x568) */
#define MP2_CPU2_WFI_EN_LSB                 (1U << 0)       /* 1b */
/* MP2_CPU3_WFI_EN (0x10006000+0x56C) */
#define MP2_CPU3_WFI_EN_LSB                 (1U << 0)       /* 1b */
/* MP3_CPU0_WFI_EN (0x10006000+0x570) */
#define MP3_CPU0_WFI_EN_LSB                 (1U << 0)       /* 1b */
/* MP3_CPU1_WFI_EN (0x10006000+0x574) */
#define MP3_CPU1_WFI_EN_LSB                 (1U << 0)       /* 1b */
/* MP3_CPU2_WFI_EN (0x10006000+0x578) */
#define MP3_CPU2_WFI_EN_LSB                 (1U << 0)       /* 1b */
/* MP3_CPU3_WFI_EN (0x10006000+0x57C) */
#define MP3_CPU3_WFI_EN_LSB                 (1U << 0)       /* 1b */
