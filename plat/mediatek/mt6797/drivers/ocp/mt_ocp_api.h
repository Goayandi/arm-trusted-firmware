...
#define GET_BITS_VAL(_bits_, _val_)	(((_val_) & (BITMASK(_bits_))) >> \
						 ((0) ? _bits_))
...
// LITTLE1
// mp0_ocpenable     ocp enable register
#define MP0_OCP_ENABLE         (OCP_BASE_ADDR + 0x1040)
// mp0_maf_ctrl      maf control register
#define MP0_MAF_CTRL           (OCP_BASE_ADDR + 0x1044)
// mp0_ocplkg_ctrl   lkgmonitor control
#define MP0_OCP_LKG_CTRL       (OCP_BASE_ADDR + 0x1058)
// mp0_oc_ctrl       OC control  -->  OCWASel,fpiwasel,OCMin
#define MP0_OCP_OC_CTRL        (OCP_BASE_ADDR + 0x105C)
// mp0_ocpscale_ctrl scale register
#define MP0_OCP_SCAL           (OCP_BASE_ADDR + 0x115C)
// mp0_coptoplkgmon_ctrl Bit 0 : TopLkgInit
#define MP0_OCP_NCPU_LKGMON    (OCP_BASE_ADDR + 0x1160)
// mp0_coptoplkgmon_ctrl Bit 0~3 : Cpu0~3LkgInit
#define MP0_OCP_CPU_LKGMON     (OCP_BASE_ADDR + 0x1164)

// mp0_ocpcpuevsel   core event sel control register
#define MP0_OCP_CPU_EVSEL      (OCP_BASE_ADDR + 0x116C)
// mp0_ocpncpuevsel  non-core event sel control register
#define MP0_OCP_NCPU_EVSEL     (OCP_BASE_ADDR + 0x1170)

// mp0_ocpcpuevshift  core event shift control register
#define MP0_OCP_CPU_EVSHIFT0   (OCP_BASE_ADDR + 0x1174)
// mp0_ocpcpuevshift1 core event shift control register
#define MP0_OCP_CPU_EVSHIFT1   (OCP_BASE_ADDR + 0x1178)
// mp0_ocpcpuevshift2 core event shift control register
#define MP0_OCP_CPU_EVSHIFT2   (OCP_BASE_ADDR + 0x117C)

// mp0_ocpncpuevshift  non-core event shift register
#define MP0_OCP_NCPU_EVSHIFT0  (OCP_BASE_ADDR + 0x1180)
// mp0_ocpncpuevshift1 non-core event shift register
#define MP0_OCP_NCPU_EVSHIFT1  (OCP_BASE_ADDR + 0x1184)

// mp0_ocpcpur0   OCP Core coeff for power index 0
#define MP0_OCP_CPU_R0         (OCP_BASE_ADDR + 0x10A0)
// mp0_ocpcpur1   OCP Core coeff for power index 1
#define MP0_OCP_CPU_R1         (OCP_BASE_ADDR + 0x10A4)
// mp0_ocpcpur2   OCP Core coeff for power index 2
#define MP0_OCP_CPU_R2         (OCP_BASE_ADDR + 0x10A8)
// mp0_ocpcpur3   OCP Core coeff for power index 3
#define MP0_OCP_CPU_R3         (OCP_BASE_ADDR + 0x10AC)
// mp0_ocpcpur4   OCP Core coeff for power index 4
#define MP0_OCP_CPU_R4         (OCP_BASE_ADDR + 0x10B0)
// mp0_ocpcpur5   OCP Core coeff for power index 5
#define MP0_OCP_CPU_R5         (OCP_BASE_ADDR + 0x10B4)
// mp0_ocpcpur6   OCP Core coeff for power index 6
#define MP0_OCP_CPU_R6         (OCP_BASE_ADDR + 0x10B8)
// mp0_ocpcpur7   OCP Core coeff for power index 7
#define MP0_OCP_CPU_R7         (OCP_BASE_ADDR + 0x10BC)
// mp0_ocpcpur8   OCP Core coeff for power index 8
#define MP0_OCP_CPU_R8         (OCP_BASE_ADDR + 0x10C0)
// mp0_ocpcpur9   OCP Core coeff for power index 9
#define MP0_OCP_CPU_R9         (OCP_BASE_ADDR + 0x10C4)
// mp0_ocpcpur10  OCP Core coeff for power index 10
#define MP0_OCP_CPU_R10        (OCP_BASE_ADDR + 0x10C8)
// mp0_ocpcpur11  OCP Core coeff for power index 11
#define MP0_OCP_CPU_R11        (OCP_BASE_ADDR + 0x10CC)
// mp0_ocpcpur12  OCP Core coeff for power index 12
#define MP0_OCP_CPU_R12        (OCP_BASE_ADDR + 0x10D0)
// mp0_ocpcpur13  OCP Core coeff for power index 13
#define MP0_OCP_CPU_R13        (OCP_BASE_ADDR + 0x10D4)
// mp0_ocpcpur14  OCP Core coeff for power index 14
#define MP0_OCP_CPU_R14        (OCP_BASE_ADDR + 0x10D8)
// mp0_ocpcpur15  OCP Core coeff for power index 15
#define MP0_OCP_CPU_R15        (OCP_BASE_ADDR + 0x10DC)
// mp0_ocpcpur16  OCP Core coeff for power index 16
#define MP0_OCP_CPU_R16        (OCP_BASE_ADDR + 0x10E0)

// mp0_ocpncpu0   OCP TOP coeff for power index 0
#define MP0_OCP_NCPU_R0        (OCP_BASE_ADDR + 0x1100)
// mp0_ocpncpu1   OCP TOP coeff for power index 1
#define MP0_OCP_NCPU_R1        (OCP_BASE_ADDR + 0x1104)
// mp0_ocpncpu2   OCP TOP coeff for power index 2
#define MP0_OCP_NCPU_R2        (OCP_BASE_ADDR + 0x1108)
// mp0_ocpncpu3   OCP TOP coeff for power index 3
#define MP0_OCP_NCPU_R3        (OCP_BASE_ADDR + 0x110C)
// mp0_ocpncpu4   OCP TOP coeff for power index 4
#define MP0_OCP_NCPU_R4        (OCP_BASE_ADDR + 0x1110)
// mp0_ocpncpu5   OCP TOP coeff for power index 5
#define MP0_OCP_NCPU_R5        (OCP_BASE_ADDR + 0x1114)
// mp0_ocpncpu6   OCP TOP coeff for power index 6
#define MP0_OCP_NCPU_R6        (OCP_BASE_ADDR + 0x1118)
// mp0_ocpncpu7   OCP TOP coeff for power index 7
#define MP0_OCP_NCPU_R7        (OCP_BASE_ADDR + 0x111C)
// mp0_ocpncpu8   OCP TOP coeff for power index 8
#define MP0_OCP_NCPU_R8        (OCP_BASE_ADDR + 0x1120)

// mp0_ocpcpuroff Roff coefficient
#define MP0_OCP_CPU_ROFF       (OCP_BASE_ADDR + 0x108C)
// mp0_ocpncpulkg non-core leakage
#define MP0_OCP_NCPU_LKG       (OCP_BASE_ADDR + 0x1140)
// mp0_ocpcpurlkg cpu leakage
#define MP0_OCP_CPU_LKG        (OCP_BASE_ADDR + 0x1144)

// mp0_ocpfpidtki fpi control
#define MP0_OCP_FPIDTKI        (OCP_BASE_ADDR + 0x1148)
// mp0_ocpfreq_   ctrl freq control register
#define MP0_OCP_FREQ_CTRL      (OCP_BASE_ADDR + 0x114C)
// mp0_ocpfpikp   fpi control
#define MP0_OCP_FPIKP          (OCP_BASE_ADDR + 0x1150)

// mp0_idvfs_vact IDVFS_VACT
#define MP0_OCP_IDVFS_VACT     (OCP_BASE_ADDR + 0x118C)
// mp0_idvfs_vpred IDVFS_VPRED
#define MP0_OCP_IDVFS_VPRED    (OCP_BASE_ADDR + 0x1190)
// mp0_idvfs_fact IDVFS_FACT
#define MP0_OCP_IDVFS_FACT     (OCP_BASE_ADDR + 0x1194)
#define MP0_OCP_IDVFS_VREQMAX  (OCP_BASE_ADDR + 0x1198)
// mp0_idvfs_vact_wr idvfs_vact_wr
#define MP0_OCP_IDVFS_VACT_WR  (OCP_BASE_ADDR + 0x119C)
#define MP0_OCP_IDVFS_VPRED_WR (OCP_BASE_ADDR + 0x11A0)
// mp0_idvfs_fact_wr idvfs_fact_wr
#define MP0_OCP_IDVFS_FACT_WR  (OCP_BASE_ADDR + 0x11A4)
#define MP0_OCP_IDVFS_FREQMAX  (OCP_BASE_ADDR + 0x11A8)

// mp0_ocpcpupost_ctrl0 event0~9 post control
#define MP0_OCP_CPU_POSTCTRL0  (OCP_BASE_ADDR + 0x1700)
// mp0_ocpcpupost_ctrl1 event10~19 post control
#define MP0_OCP_CPU_POSTCTRL1  (OCP_BASE_ADDR + 0x1704)
// mp0_ocpcpupost_ctrl2 event20~29 post control
#define MP0_OCP_CPU_POSTCTRL2  (OCP_BASE_ADDR + 0x1708)
// mp0_ocpcpupost_ctrl3 event30~39 post control
#define MP0_OCP_CPU_POSTCTRL3  (OCP_BASE_ADDR + 0x170C)
// mp0_ocpcpupost_ctrl4 event40~49 post control
#define MP0_OCP_CPU_POSTCTRL4  (OCP_BASE_ADDR + 0x1710)
// mp0_ocpcpupost_ctrl5 event50~59 post control
#define MP0_OCP_CPU_POSTCTRL5  (OCP_BASE_ADDR + 0x1714)
// mp0_ocpcpupost_ctrl6 event60~69 post control
#define MP0_OCP_CPU_POSTCTRL6  (OCP_BASE_ADDR + 0x1718)
// mp0_ocpcpupost_ctrl7 event70~79 post control
#define MP0_OCP_CPU_POSTCTRL7  (OCP_BASE_ADDR + 0x171C)

// mp0_ocppncpupost_ctrl ncpu-event0~9 post control
#define MP0_OCP_NCPU_POSTCTRL0 (OCP_BASE_ADDR + 0x17A0)

// mp0_ocpocwatgt ocwatgt (Q8.12)
#define MP0_OCP_OCWATGT        (OCP_BASE_ADDR + 0x1060)
// mp0_ocp_voltage_ctrl voltage control register
#define MP0_OCP_VOLT_CTRL      (OCP_BASE_ADDR + 0x1070)
// mp0_ocpockp oc kp control
#define MP0_OCP_OCKP           (OCP_BASE_ADDR + 0x1154)
// mp0_ocpocdtki oc dtki control
#define MP0_OCP_OCDTKI         (OCP_BASE_ADDR + 0x1158)
// mp0_ocp_general_ctrl
...
// mp1_coptoplkgmon_ctrl Bit 0 : TopLkgInit
#define MP1_OCP_NCPU_LKGMON    (OCP_BASE_ADDR + 0x3160)
// mp1_coptoplkgmon_ctrl Bit 0~3 : Cpu0~3LkgInit
#define MP1_OCP_CPU_LKGMON     (OCP_BASE_ADDR + 0x3164)
...
// mp1_ocpncpulkg non-core leakage
#define MP1_OCP_NCPU_LKG       (OCP_BASE_ADDR + 0x3140)
// mp1_ocpcpurlkg cpu leakage
#define MP1_OCP_CPU_LKG        (OCP_BASE_ADDR + 0x3144)
...
extern int LittleOCPCapture(int Cluster, int EnDis, int Edge, int Count,
		int Trig);
