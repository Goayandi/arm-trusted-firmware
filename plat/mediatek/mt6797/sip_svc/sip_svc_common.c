		...
		uint64_t flags)
{
	...
	case MTK_SIP_KERNEL_IDVFS_BIGIDVFSENABLE_AARCH64:
		/*
		 * Fmax = 500 ~ 3000, Vproc_mv_x100 = 50000~120000,
		 * VSram_mv_x100 = 50000~120000
		 */
	...
	case MTK_SIP_KERNEL_OCP_WRITE_AARCH64:
		/*
		 * OCP_BASE_ADDR= 0x10220000, only for
		 * secure reg 0x10220000 ~ 0x10224000
		 */
	...
	case MTK_SIP_KERNEL_OCP_READ_AARCH64:
		/* OCP_BASE_ADDR= 0x10220000,
		 *	only for secure reg 0x10220000 ~ 0x10224000
		 */
		if ((x1 & 0xFFFFC000) != (OCP_BASE_ADDR & 0xFFFFC000))
			return SIP_SVC_E_INVALID_Range;
		rc = mmio_read_32(x1);
