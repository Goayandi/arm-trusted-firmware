...
static void gicd_v3_set_irouter(unsigned int base, unsigned int id,
				uint64_t aff)
{
...
extern void gicd_write_igroupr(uintptr_t base, unsigned int id,
				unsigned int val);
extern void gicd_clr_igroupr(uintptr_t base, unsigned int id);
extern void gicd_write_ipriorityr(uintptr_t base, unsigned int id,
				unsigned int val);
